...
export CLASSPATH="\
$(find /var/lib/minecraft/mods -type f -name '*.jar' -exec printf '%s:' {} \;)\
$(find /var/lib/minecraft/.cache -type f -name '*.jar' -exec printf '%s:' {} \;)\
$(find /var/lib/minecraft/versions -type f -name '*.jar' -exec printf '%s:' {} \;)\
$(find /var/lib/minecraft/libraries -type f -name '*.jar' -exec printf '%s:' {} \;)\
$(find /usr/local/lib/minecraft/libraries -type f -name '*.jar' -exec printf '%s:' {} \;)\
/usr/local/lib/*:\
...
# /usr/local/lib/minecraft/libraries/net/fabricmc/intermediary/1.20.1/intermediary-1.20.1.jar:\
